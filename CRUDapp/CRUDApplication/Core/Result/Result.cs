namespace CRUDApplication.Core.Result
{
    public class Result : IResult
    {
        ...
        /// </summary>
        /// <param name="message">info message parameter</param>
        /// <param name="data">object collection parameter</param>
        /// <returns>It returns fully qualified Result object.</returns>
        ...
        /// <param name="data">object collection parameter</param>
        /// <returns>It returns fully qualified Result object.</returns>
        public Result Success(string message, string pageName, object data)
        {
            return new Result
            {
                IsSuccess = true,
        ...
        /// <param name="data">object collection parameter</param>
        /// <returns>It returns fully qualified Result object.</returns>
        public Result Warning(string message, string condition, object data)
        {
            return new Result
            {
                IsSuccess = false,
        ...
        /// <returns>It returns fully qualified Result object.</returns>
        public Result Fail(string message, string exception="")
        {
            return new Result
            {
                IsSuccess = false,
